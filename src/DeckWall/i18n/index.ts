...
const zh = {
  ...
  productionBrand: '彩色背面已经进入封存，正在用 AlterU α 制作更克制的黑底品牌正面。',
  productionSaving: '两面图已经完成，正在写入作品墙并准备打开最终详情。',
  productionNote0: '主体会被放在板身中线，避免圆角裁掉重点。',
...
const en: typeof zh = {
  ...
  productionBrand: 'The color side is sealed. Building a quieter black AlterU alpha brand side now.',
  productionSaving: 'Both sides are ready. Saving the deck to the wall and preparing the final detail view.',
  productionNote0: 'The subject stays near the board centerline so rounded ends do not crop the focus.',
