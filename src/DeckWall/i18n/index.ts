...
const zh = {
  ...
  craftCooldownTitle: '制板间封存中',
  craftCooldownSub: '{n} 后开放下一块板',
  like: '喜欢',
  liked: '已喜欢',
  comments: '留言',
  noComments: '还没有留言，给这块板留第一道划痕。',
  commentPlaceholder: '给这块板留一句话',
  commentPlaceholderFor: '给 {n} 留一句话',
  commentPlaceholderSelf: '给自己的滑板留一句话',
  sendComment: '发送',
  commentCount: '{n} 条留言',
  likeCount: '{n} 人喜欢',
  ...
  productionSaving: '两面图已经完成，正在封层、写入作品墙，并预载最终详情里的图片。',
...
const en: typeof zh = {
  ...
  craftCooldownTitle: 'Deck room sealed',
  craftCooldownSub: 'Next deck opens in {n}',
  like: 'Like',
  liked: 'Liked',
  comments: 'Notes',
  noComments: 'No notes yet. Leave the first scratch on this deck.',
  commentPlaceholder: 'Leave a note on this deck',
  commentPlaceholderFor: 'Leave a note for {n}',
  commentPlaceholderSelf: 'Leave a note on your deck',
  sendComment: 'Send',
  ...
  productionSaving: 'Both sides are ready. Sealing the deck, saving it to the wall, and preloading the final detail images.',
